...
FUN.results_replacer('wood-to-coal', 'coal', 'raw-coal',1)
FUN.results_replacer('coal-gas-from-wood', 'coal', 'raw-coal', 6)
RECIPE('wood-to-coal'):remove_unlock('coal-processing-3'):add_unlock('coal-processing-2')
